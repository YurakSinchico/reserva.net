...
namespace Reserva.API.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public ReservasController(ReservaAPIContext context)
        {
            _context = context;
        }
        ...
        {
            var reservas = await _context.Reservas.Include(r => r.Canchas).ThenInclude(t=>t.Tipo_Canchas).
               Include(r => r.Clientes).Include(r=>r.Horarios).ToListAsync();
            return reservas;
        }
        ...
        {
            var reservas = await _context.Reservas.Include(r => r.Canchas).ThenInclude(t => t.Tipo_Canchas).Include(r => r.Clientes).Include(r => r.Horarios)
